...
//        flowSensorAnalogI.setPayloadType("ANALOG");
//    }
//
//    @Test
...
//        Mockito.when(payloadTypeMock.asText()).thenReturn("ANALOG");
//
...
//        JsonNode payloadTypeMock = Mockito.mock(JsonNode.class);
//        Mockito.when(jn.findValue(Mockito.same("payloadType"))).thenReturn(payloadTypeMock);
//        Mockito.when(payloadTypeMock.asText()).thenReturn("DEVICE_CONNECTED");
//
//        JsonNode codeJsonNode = Mockito.mock(JsonNode.class);
//        Mockito.when(jn.findValue(Mockito.same("code"))).thenReturn(codeJsonNode);
