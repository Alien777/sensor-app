...
public interface SensorMicroserviceEndpoint {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/api/sensor/send/analog")
    void sendRequestForDataAnalog(@RequestBody SendForAnalogData configS) throws Exception;
